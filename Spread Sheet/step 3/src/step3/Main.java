...
static Region spreadSheet = new Region(2);
...
static CellAddress temp3=new CellAddress();static CellAddress temp6=new CellAddress();
    ...
    public static void main(String[] args) {
        spreadSheet.sheet[0]=new Column(5);
        spreadSheet.sheet[1]=new Column(5);
        ...
        temp1.setAddress(1,"A");temp2.setAddress(3,"B");temp3.setAddress(5,"A");temp4.setAddress(4,"A");
        temp5.setAddress(4,"B");temp6.setAddress(5,"B");

        printTheGrid();
        findTheMaxOfTheArea();
        findTheMinOfTheArea();
        findTheRangeOfValueOfTheArea();
        findTheTotalOfTheArea();
        findTheAverageOfTheArea();

    }
    public static void findTheMaxOfTheArea(){
        spreadSheet.sheet[0].Acolumn[4].input(spreadSheet.max(temp1, temp2));
        System.out.println("Max of the Area : "+ temp1.column+""+(temp1.raw+1) + " - "+ temp2.column+""+(temp2.raw+1)+" is :"+spreadSheet.sheet[0].Acolumn[4].output());
    } 
    public static void findTheMinOfTheArea(){
        spreadSheet.sheet[0].Acolumn[4].input(spreadSheet.min(temp1, temp2));
        System.out.println("Min of the Area : "+ temp1.column+""+(temp1.raw+1) + " - "+ temp2.column+""+temp2.raw+1+" is :"+spreadSheet.sheet[0].Acolumn[4].output());
    }
    public static void findTheRangeOfValueOfTheArea(){
        spreadSheet.sheet[0].Acolumn[4].input(spreadSheet.rangeOfValues(temp1, temp2));
        System.out.println("Range of the values  of the Area : "+ temp1.column+""+(temp1.raw+1) + " - "+ temp2.column+""+(temp2.raw+1)+" is :"+spreadSheet.sheet[0].Acolumn[4].output());
    }
    public static void findTheTotalOfTheArea(){
        spreadSheet.sheet[0].Acolumn[4].input(spreadSheet.total(temp1, temp2));
        System.out.println("Total of the Area : "+ temp1.column+""+(temp1.raw+1 )+ " - "+ temp2.column+""+(temp2.raw+1)+" is :"+spreadSheet.sheet[0].Acolumn[4].output());
    }
    public static void findTheAverageOfTheArea(){
        spreadSheet.sheet[0].Acolumn[4].input(spreadSheet.average(temp1, temp2));
        System.out.println("Average of the Area : "+ temp1.column+""+(temp1.raw+1) + " - "+ temp2.column+""+(temp2.raw+1)+" is :"+spreadSheet.sheet[0].Acolumn[4].output());
    }
...
class Region{
    ...
    public Region(int no){
    limit=no;  
    sheet=new Column[limit];
    }
